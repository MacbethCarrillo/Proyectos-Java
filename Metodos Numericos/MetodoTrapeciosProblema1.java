...
public class MetodoTrapeciosProblema1 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Cuantos procesos se van a realizar? ");
		tp = scan.nextInt();
		ca = a;
		System.out.println("");
		...
		do {
			...
			System.out.printf("| %10s | %10s | %10s | %10s | %10s | %10s|%n", "Trapecio", "a", "a+h", "f(a)", "f(a+h)", "Area");
			System.out.println("-------------------------------------------------------------------------------");
			np++;
			vCalc = 0;
			h = (b - a) / n;
